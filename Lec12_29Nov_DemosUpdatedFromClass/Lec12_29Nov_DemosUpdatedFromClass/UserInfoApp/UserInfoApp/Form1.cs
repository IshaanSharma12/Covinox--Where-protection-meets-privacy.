...
using System.Linq; //Linq namespace needed for linq
using System.Text;
    ...
    public partial class Form1 : Form
    {
        ...
        private void WriteToFileBtn_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                mySecondForm.SecondFormLabel.Text = "Thank you!!\n" + StatusLabel.Text;

                //mySecondForm.Show();
                //MessageBox.Show("This message appears after Show");

                mySecondForm.ShowDialog();
                MessageBox.Show("This message appears after Show Dialog");
        ...
        private void SortUsersByAgeBtn_Click(object sender, EventArgs e)
        {
            ...
            SortedList = (from user in UserList
                          orderby user.UserName
                          where user.UserAge > 50
                          select user).ToList();
